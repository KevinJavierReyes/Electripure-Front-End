...
export const sendActivateDeactivateUser = (payload: SendActivateDeactivateUserPayload) : any => (async (dispatch: any) => {
    dispatch(setLoading({
        loading: true
    }));
