...
function InputCheckbox({ state, message, name, label, onChange, classes="" }: { state: INPUT_CONTROL_STATE, message: string, name: string, label: string, onChange: (checked: boolean) => void, classes?: string }) {
