...
function InputPhoto({ name, placeholder, onChange } : { name: string, placeholder:string, onChange : (base64: string) => void}) {
    ...
    return (
        <div className="w-full h-full min-h-[80px] relative overflow-hidden">
            <div className="bg-color-secondary flex justify-center items-center rounded-lg w-full h-full absolute top-0 left-0">
